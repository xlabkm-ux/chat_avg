...
class RetrievalChunk {
    ...
    validate() {
        if (!this.id)
            throw new Error('RetrievalChunk: Missing id');
        if (!this.sourceId)
            throw new Error('RetrievalChunk: Missing sourceId');
        if (!this.text)
            throw new Error('RetrievalChunk: Missing text');
...
class RetrievalResult {
    ...
    validate() {
        if (!this.query)
            throw new Error('RetrievalResult: Missing query');
